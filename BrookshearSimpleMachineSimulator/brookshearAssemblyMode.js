ace.define("ace/mode/assembly_x87_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules"], function (require, exports, module) {
    "use strict";

    var oop = require("../lib/oop");
    var TextHighlightRules = require("./text_highlight_rules").TextHighlightRules;

    var AssemblyBrookshearHighlightRules = function () {
    ...
    AssemblyBrookshearHighlightRules.metaData = {
        fileTypes: ['asm'],
        name: 'Assembly x87',
    ...
    oop.inherits(AssemblyBrookshearHighlightRules, TextHighlightRules);

    exports.AssemblyX87HighlightRules = AssemblyBrookshearHighlightRules;
});
...
ace.define("ace/mode/assembly_x87", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/mode/assembly_x87_highlight_rules", "ace/mode/folding/coffee"], function (require, exports, module) {
    "use strict";

    var oop = require("../lib/oop");
    var TextMode = require("./text").Mode;
    var AssemblyX87HighlightRules = require("./assembly_x87_highlight_rules").AssemblyX87HighlightRules;
    var FoldMode = require("./folding/coffee").FoldMode;

    var Mode = function () {
        this.HighlightRules = AssemblyX87HighlightRules;
    ...
    (function () {
        ...
        this.$id = "ace/mode/assembly_x87";
    }).call(Mode.prototype);

    exports.Mode = Mode;
}); (function () {
    ace.require(["ace/mode/assembly_x87"], function (m) {
